...
alias vimrc="vim /Users/gabor.nadai/.vimrc"
alias zshrc="vim /Users/gabor.nadai/.zshrc"
...
# oh-my-zsh plugins
plugins=(brew fasd git jira npm sudo wd fzf-tab zsh-autosuggestions)
...
# Autosuggest strategy: first history, then tab completion
